...
export const lifestyleQuestions = [
  // noise
  {
    ...
    choices: [
      ...
      { label: 'B', text: '조금 불편하지만, 길어지지 않으면 굳이 신경 쓰지 않는다.', score: 4 },
      { label: 'C', text: '일단 참았다가 나중에 이야기한다.', score: 6 },
  ...
  },
  {
    ...
    choices: [
      ...
      { label: 'D', text: '도저히 집중할 수 없어 무소음 마우스/키보드 사용을 강하게 요구한다.', score: 8 },
    ],
  },
  ...
  // cleanliness
  {
    ...
    choices: [
      ...
      { label: 'B', text: '조금 불편하다. 며칠 더 지켜보고도 안 치우면 그때 이야기한다.', score: 4 },
      { label: 'C', text: '치워달라고 즉시 이야기한다.', score: 6 },
  ...
  // sleep
  {
    ...
    choices: [
      ...
      { label: 'C', text: '정해진 시간에 자고 일어나는 편이라, 아침에는 조금만 조용히 해달라고 부탁한다.', score: 6 },
